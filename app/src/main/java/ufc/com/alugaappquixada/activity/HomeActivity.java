...
public class HomeActivity extends FragmentActivity
        implements OnMapReadyCallback,MapView, EnterpriseView {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mapPresenter = new MapPresenterImpl(this,this, this);
        ...
        buttonViewDetails.setOnClickListener( (view) -> {
            Intent intent = new Intent(this,DetailsApartmentActivity.class);
            Bundle bundle = new Bundle();

            intent.putExtra("enterpriseId", this.enterprise.getId());
    ...
    public void getEnterprise(Enterprise enterprise) {
        Logger.getAnonymousLogger().info(enterprise.getDescription());
